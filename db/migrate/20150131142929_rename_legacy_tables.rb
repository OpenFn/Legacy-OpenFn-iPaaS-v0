class RenameLegacyTables < ActiveRecord::Migration
  def change
    ...
    rename_table :odk_field_salesforce_fields, :odk_sf_legacy_odk_field_salesforce_fields
    rename_table :odk_forms, :odk_sf_legacy_odk_forms
    rename_table :salesforce_objects, :odk_sf_legacy_salesforce_objects
    rename_table :salesforce_relationships, :odk_sf_legacy_salesforce_relationships
